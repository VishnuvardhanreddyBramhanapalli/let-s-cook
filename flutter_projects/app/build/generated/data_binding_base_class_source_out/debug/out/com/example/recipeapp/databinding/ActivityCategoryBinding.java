...
public final class ActivityCategoryBinding implements ViewBinding {
  ...
  private ActivityCategoryBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView itemImage,
      @NonNull ConstraintLayout main, @NonNull RecyclerView rvCategory, @NonNull TextView title) {
  ...
  public static ActivityCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCategoryBinding((ConstraintLayout) rootView, itemImage, main, rvCategory,
          title);
    }
